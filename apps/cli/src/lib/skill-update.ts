...
// The pack lives in the OSS monorepo under public-skill/ (generated by
// services/api-v2/scripts/generate-public-skill.ts; CI fails on drift).
const REMOTE_BASE =
  'https://raw.githubusercontent.com/gitroomhq/agent-media-app/main/public-skill';

// Canonical version anchor: the one skill of the loose surface carries the
// bundle's `x-skill-version`.
const REMOTE_URL = `${REMOTE_BASE}/skills/agent-media/SKILL.md`;
...
const SKILL_TREE: ReadonlyArray<{ remote: string; local: string }> = [
  { remote: 'skills/agent-media/SKILL.md', local: 'SKILL.md' },
  ...
  { remote: 'reference/models.md', local: 'reference/models.md' },
  { remote: 'reference/prompting.md', local: 'reference/prompting.md' },
  { remote: 'reference/recipes.md', local: 'reference/recipes.md' },
  { remote: 'reference/tools.md', local: 'reference/tools.md' },
