...
/**
 * POST /api/v1/generate/character_video
 *
 * Same-origin proxy to api-v2's /v1/generate/character_video.
 * Used by the Content Machine wizard step 3 (final video render).
 */
...
export async function POST(req: NextRequest) {
  ...
  try {
    const upstream = await fetch(`${API_V2_URL}/v1/generate/character_video`, {
      method: 'POST',
      headers: {
