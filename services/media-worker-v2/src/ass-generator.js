 ...
 */
export function generateASS(words, style = 'hormozi', aspectRatio = '9:16', { marginVOverride } = {}) {
  ...
  const marginV = marginVOverride ?? (aspectRatio === '9:16' ? cfg.marginV : Math.round(cfg.marginV * 0.6));
