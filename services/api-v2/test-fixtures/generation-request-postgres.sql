...
CREATE TABLE skill_runs(id uuid PRIMARY KEY, user_id uuid NOT NULL, status text NOT NULL, created_at timestamptz NOT NULL DEFAULT now());
...
\ir 20260920130000_atomic_generation_admission.sql
